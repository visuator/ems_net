...
public class GeolocationStudentRecordSessionJob : IJobBase
{
    ...
    public class QuartzHandler : IJob
    {
        ...
        public QuartzHandler(EmsDbContext dbContext, IOptions<GeolocationStudentRecordSessionOptions> geolocationStudentRecordSessionOptions)
        {
    ...
    private static Dictionary<ArrayType, List<Guid>> GetMajorityAndMinority(ICollection<(Guid StudentRecordId, int Distance)> data, int threshold)
    {
